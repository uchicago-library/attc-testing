...
then git -C $1-branch stash
     ...
     opam exec -- dune exec --display=quiet -- attc --backend=ocamlnet < ../input/iPres-example.mbox > ../output/iPres-example_$1_ocamlnet.mbox 2> ../output/kaegiw_inbox_$1_errors_ocamlnet.log
